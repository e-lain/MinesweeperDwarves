...
#}
#
#func set_type(value: BuildingData.Type) -> void:
#	type = value
#	var building_data := BuildingData.get_building_data(type)
...
#
#
###  Return true when the building model would be able to be placed at the cell position mapping to the given global position. False otherwise
#func can_place() -> bool:
#	return  .can_place()
#
...
#	global_position = Globals.snap_position(world_pos)
...
#
#	var bounds = Rect2(global_position, Vector2(Globals.TILE_SIZE, Globals.TILE_SIZE) * size.x)
