...
@export var rect_max_size: Vector2 = Vector2(MAX_FLOAT, MAX_FLOAT) : set = set_custom_maximum_size
func set_custom_maximum_size(to):
	rect_max_size = to
	fit_child()

@export var align = Align.CENTER : set = set_align
func set_align(to):
	align = to
	fit_child()

@export var valign = VAlign.CENTER : set = set_valign
func set_valign(to):
	valign = to
	fit_child()
...
func _get_minimum_size() -> Vector2:
	var rect_min_size = get_minimum_size()
